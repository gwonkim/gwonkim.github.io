export const test = `
          ...
          가능
          ex) grep main *.java(현재 폴더의 java 파일 중 main이라는 문자열이
          있는 파일명 출력) ex) ls -l | grep zip(현재 폴더에서 zip 문자열이
          포함된 줄 출력, 압축 파일 찾기)
